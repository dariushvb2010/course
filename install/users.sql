...
--
-- Host: localhost
-- Generation Time: Jul 25, 2012 at 03:05 PM
...
(2, 'abbas', 'e3110a4037859d441e7795c40ceced7c2e7360f72dc865253629d5ba7872dbd06bc36e6beffdbd0d8b4b7e722285e7eb2e81009343f11ab592c9503dd2d5e414', 'MyUser');
...
('', 0, '0', 1313676041, 1313676041, 0, 1313676041, 1, 1313612641, 2);
...
--
INSERT INTO `app_MyUser` (`Firstname`, `Lastname`, `State`, `isReviewer`, `Group1ID`, `ID`, `gender`, `Codemelli`) VALUES
('عباس', 'نادری', 1, 1, 1, 2, 0, '');
